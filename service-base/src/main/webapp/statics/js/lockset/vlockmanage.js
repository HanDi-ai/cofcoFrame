$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '创建人', name: 'createPerson', index: 'CREATE_PERSON', width: 50},
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.vLockManage.agingTestCount == null ? "../vlockmanage/save" : "../vlockmanage/update";
            $.ajax({
                type: "POST",
                url: url,
                data: JSON.stringify(vm.vLockManage),
                success: function (r) {
                    if (r.code === 0) {
        ...
        getInfo: function (agingTestCount) {
            $.get("../vlockmanage/info/" + agingTestCount, function (r) {
                if (r.code == 0) {
                    vm.vLockManage = r.vLockManage;
                } else {
                    alert(r.msg);
                }
            });
