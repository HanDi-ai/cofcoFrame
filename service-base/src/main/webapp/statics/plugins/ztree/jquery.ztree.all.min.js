...
a.getParentNode():h.getRoot(b),e=0,g=d[c].length-1;e<=g;e++)if(d[c][e]===a)return e==g?null:d[c][e+1];return null},getNodeByParam:function(b,a,c,d){if(!a||!c)return null;for(var e=b.data.key.children,g=0,l=a.length;g<l;g++){if(a[g][c]==d)return a[g];var f=h.getNodeByParam(b,a[g][e],c,d);if(f)return f}return null},getNodeCache:function(b,a){if(!a)return null;var c=w[b.treeId].nodes[h.getNodeCacheId(a)];return c?c:null},getNodeName:function(b,a){var text = b.data.key.nameFormat; if (b.data.key.nameArray && text) {for (var i=0;i!=b.data.key.nameArray.length;++i) {text = text.replace("%s",a[b.data.key.nameArray[i]]);} return text;}return""+a[b.data.key.name]},getNodePath:function(b,a){if(!a)return null;
